...
export default function App() {
  useEffect(() => { const image = document.querySelector<HTMLImageElement>('.context-figure img'); if (image) image.src = `${import.meta.env.BASE_URL}assets/workshop-context.png`; }, []);
